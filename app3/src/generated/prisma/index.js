...
exports.Prisma.Todo3ScalarFieldEnum = {
  id: 'id',
  title: 'title',
  completed: 'completed'
};
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/renjerpink/Documents/Pemrograman/JS/expressjs-boilerplate/app3/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "sourceFilePath": "/home/renjerpink/Documents/Pemrograman/JS/expressjs-boilerplate/app3/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider        = \"prisma-client-js\"\n  output          = \"../src/generated/prisma\"\n  previewFeatures = [\"multiSchema\"]\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n  schemas  = [\"app3_schema\"]\n}\n\nmodel Todo3 {\n  id        Int     @id @default(autoincrement())\n  title     String\n  completed Boolean @default(false)\n\n  @@schema(map: \"app3_schema\")\n}\n",
  "inlineSchemaHash": "a495240ce5074f3407c6abec0d55d564daed8fdec12826a30f5cb14bae3390b1",
  "copyEngine": true
}
